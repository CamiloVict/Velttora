export default {
  meta: {
    ...
    description:
      "Velttora LLC construye plataformas de software que transforman industrias lentas y fragmentadas — desde cobranza y GovTech hasta marketplaces educativos y competencias fitness.",
  },
  nav: {
    about: "Nosotros",
    products: "Productos",
    ...
    items: [
      {
        ...
        description:
          "Eudify conecta familias con educadores y cuidadores certificados, con un plan anual de aprendizaje basado en ciencia. Integra metodología OMS/AAP/UNICEF, matching con IA, verificación KYC y seguimiento curricular por niño.",
        tags: [
          "EdTech",
          "Marketplace",
          "IA",
          "Global",
          { label: "Eudifya.co", href: "https://www.Eudify.co/" },
        ],
        delay: null,
      },
      {
      ...
      },
      {
        ...
        description:
          "Hycap es el sistema operativo para competencias de fitness funcional — CrossFit, Hyrox, Iron Race. Perfiles digitales, leaderboards en tiempo real y gamificación. Inscripciones, heats y resultados en vivo desde una sola plataforma.",
  ...
  team: {
    ...
    bio1: "Builder, estratega de producto y emprendedor de Cali, Colombia. Camilo fundó Velttora LLC con una tesis: las empresas de tecnología más impactantes las construyen quienes entienden profundamente los problemas de su región — y tienen la ambición de resolverlos a escala global.",
    bio2: "Lidera estrategia de producto, arquitectura técnica y relaciones comerciales en todos los productos Velttora — desde GovTech para gobiernos hasta fintech con IA y marketplaces educativos globales.",
    linkedin: "LinkedIn",
  ...
  contact: {
    ...
    error:
      "No pudimos enviar tu mensaje. Intenta de nuevo o escribe a contact@velttora.com.",
  ...
  footer: {
    rights:
      "© 2026 Velttora LLC. Todos los derechos reservados. · Wyoming, EE. UU.",
    about: "Nosotros",
    products: "Productos",
    contact: "Contacto",
  },
